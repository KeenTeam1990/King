	...
	export default {
		...
		methods: {
			...
			showyx: function(e) {
				...
				console.log(e);
				uni.request({
					url: "https://zhanli.28php.com/hero/select.php?hero=" + yxm+ "&type=qq",
					header: {
					...
					success: function(e) {
						...
						uni.showModal({
							title: '安卓Q区：' + yxm,
							content: "最低县标：" + e.data.data.area + "\r\n英雄战力：" + e.data.data.areaPower + "\r\n最低市标：" + e.data.data.city + "\r\n英雄战力：" + e.data.data.cityPower + "\r\n最低省标：" + e.data.data.province + "\r\n英雄战力：" + e.data.data.provincePower + "\r\n更新时间：" + e.data.data.updatetime,
