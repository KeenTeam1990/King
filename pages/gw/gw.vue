...
<template>
	<view>
		<ls-loading text="英雄加载中..." animation="progress" :embed="embed" highlight-color="#027cff" v-if="pageLoading" style="margin-top: 300rpx;"></ls-loading>
			...
			showyx: function(e) {
				...
				uni.request({
					...
					success: function(e) {
						...
						uni.showModal({
							title: '苹果V区：' + yxm,
							content: "最低县标：" + e.data.data.ios_wx_area + "\r\n英雄战力：" + e.data.data.ios_wx_area_power + "\r\n最低市标：" + e.data.data.ios_wx_city + "\r\n英雄战力：" + e.data.data.ios_wx_city_power + "\r\n最低省标：" + e.data.data.ios_wx_province + "\r\n英雄战力：" + e.data.data.ios_wx_province_power + "\r\n更新时间：" + e.data.data.ios_wx_update_time,
